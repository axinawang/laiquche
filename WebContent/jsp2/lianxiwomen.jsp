...
<div class="section mainXian">
  <div class="mainConTitle"> 联系我们 </div>
...
<div class="section">
  <div class="main">
	...
	浙江越牛网络科技有限公司</div>
<div>
	地址：绍兴市越城区迪荡 博览.财智大厦25楼</div>
<div>
	邮编：312000</div>
<div>
	电话：400-0575-168</div>
<div>
	网站：www.ynlqc.com</div>

         <div style="width:100%;height:500px;border:#ccc solid 1px; margin-top:30px" id="dituContent"></div>
        </div>
      </div>
    </div>
    <div class="clear"></div>
...
<script type="text/javascript">
    ...
    function createMap(){
        ...
        var point = new BMap.Point(120.609819,30.013628);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"博览·财智大厦",content:"浙江省绍兴市越城区迪荡新城梅龙湖路80号",point:"120.609819|30.013628",isOpen:1,icon:{w:23,h:25,l:46,t:21,x:9,lb:12}}
		 ];
    //创建marker
    function addMarker(){
