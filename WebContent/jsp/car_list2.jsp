	...
	<div class="row-fluid">
		...
		<div class="row" style="width:1210px;margin:0 auto;">
			...
			<c:forEach	items="${page_bean.list }" var="p">
				<div class="col-md-2">
					<a href="${pageContext.request.contextPath}/car?method=getByCarId&car_id=${p.car_id}">
						<img src="${pageContext.request.contextPath}/${p.car_image}" width="170" height="170" style="display: inline-block;">
					</a>
					<p><a href="${pageContext.request.contextPath}/car?method=getByCarId&car_id=${p.car_id}" style='color:green'>${fn:substring(p.car_name,0,10) }...</a></p>
		...
		<div style="width:380px;margin:0 auto;margin-top:50px;">
			<ul class="pagination" style="text-align:center; margin-top:10px;">
				...
				<c:if test="${page_bean.currPage != 1 }">
					<li>
						<a href="${pageContext.request.contextPath}/car?method=findByPage&currPage=${page_bean.currPage-1}&cid=${param.cid}" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a>
					</li>
				</c:if>
				...
				<c:if test="${page_bean.currPage != page_bean.totalPage }">
					<li>
						<a href="${pageContext.request.contextPath}/product?method=findByPage&currPage=${page_bean.currPage+1}&cid=${param.cid}" aria-label="Next">
							<span aria-hidden="true">&raquo;</span>
						</a>
					</li>
				</c:if>
