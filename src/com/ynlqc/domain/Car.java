...
public class Car implements Serializable {
	/**
	 * `car_id` varchar(32) NOT NULL, `car_name` varchar(100) DEFAULT NULL,
	 * `car_date` date DEFAULT NULL, `is_hot` int(11) DEFAULT 0, `car_flag`
	 * int(11) DEFAULT 0, `guide_price` double DEFAULT NULL, `deposit` double
	 * DEFAULT NULL, `down_payment` double DEFAULT NULL, `month_payment` double
	 * DEFAULT NULL, `pay_description` text DEFAULT NULL, `car_image`
	 * varchar(200) DEFAULT NULL, `hot_image` varchar(200) DEFAULT NULL,
	 * `body_structure` varchar(100) DEFAULT NULL, `length` int(11) DEFAULT 0,
	 * `width` int(11) DEFAULT 0, `height` int(11) DEFAULT 0, `engine`
	 * varchar(100) DEFAULT NULL, `gearbox` varchar(100) DEFAULT NULL,
	 * `drive_mode` varchar(100) DEFAULT NULL, `fuel_form` varchar(20) DEFAULT
	 * NULL, `com_fuel_consumption` varchar(100) DEFAULT NULL, `body_color`
	 * varchar(100) DEFAULT NULL, `description` text DEFAULT NULL, `brand_id`
	 * int, `model_id` int, `series_id` int,
	 */
